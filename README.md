...
⚡ Note: The latest version has been upgraded – **no administrator privileges are required**. All features (Explorer restart, icon cache repair) can run directly after launching.
